...
Pour faire sa avec une TextBox, il faut passer par une propriété intermédiaire qui implémente INotifyPropertyChanged. Cette propriété sert de filtre et permet de rappeler le rafraichissement de la collection view lors d'un set. On bind cette propriété sur notre Textbox, puis dans la méthode de filtre il suffit de se baser sur cette propriété.\\
