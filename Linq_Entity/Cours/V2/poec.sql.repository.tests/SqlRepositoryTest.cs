...
public class SqlRepositoryTest
{
    ...
    {
        UserSqlRepository = new UserSqlRepository(new SqlDbContext("Data Source=.;Initial Catalog=EntityPoec;Integrated Security=True"));
    }
    ...
    public void AddTest()
    {
        ...
        AddressSqlDto address = new AddressSqlDto(0, 0, "Home", "La super adresse");
