import { FormSteamAccountComponent } from './form-steam-account/form-steam-account.component';
...
const routes: Routes = [
  ...
  {path: NavbarComponent.pathFormAccount, component: FormSteamAccountComponent}
];
