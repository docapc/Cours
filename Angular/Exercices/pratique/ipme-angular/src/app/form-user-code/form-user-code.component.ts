...
/* le point d'exclamation déclare la variable comme étant non-null même si pas initialisé
(nécessaire ici car on initialise pas la variable dans le constructeur)*/
  formGroup!: FormGroup;
  user: User = new User();
